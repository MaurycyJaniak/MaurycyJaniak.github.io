...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    {
        return $this->services['auth.provider.oauth'] = new \phpbb\auth\provider\oauth\oauth($this->get('dbal.conn'), $this->get('config'), $this->get('passwords.manager'), $this->get('request'), $this->get('user'), 'forum_oauth_tokens', 'forum_oauth_states', 'forum_oauth_accounts', $this->get('auth.provider.oauth.service_collection'), 'forum_users', $this, $this->get('dispatcher'), './../', 'php');
    }
    ...
    {
        $this->services['blitze.sitemaker.block.custom'] = $instance = new \blitze\sitemaker\blocks\custom($this->get('cache.driver'), $this->get('dbal.conn'), $this->get('request'), 'forum_sm_cblocks');
    ...
    {
        $this->services['blitze.sitemaker.block.featured_member'] = $instance = new \blitze\sitemaker\blocks\featured_member($this->get('cache.driver'), $this->get('dbal.conn'), $this->get('language'), $this->get('blitze.sitemaker.users.data'), 'forum_sm_blocks');
    ...
    {
        $this->services['blitze.sitemaker.cron.blocks_cleanup'] = $instance = new \blitze\sitemaker\cron\blocks_cleanup($this->get('config'), $this->get('dbal.conn'), $this->get('blitze.sitemaker.blocks.manager'), $this->get('blitze.sitemaker.url_checker'), 'forum_sm_blocks', 'forum_sm_cblocks');
    ...
    {
        return $this->services['blitze.sitemaker.mapper.factory'] = new \blitze\sitemaker\model\mapper_factory($this->get('config'), $this->get('dbal.conn'), array('mappers' => array('blocks' => 'forum_sm_blocks', 'routes' => 'forum_sm_block_routes', 'menus' => 'forum_sm_menus', 'items' => 'forum_sm_menu_items')));
    }
    ...
    {
        return new \blitze\sitemaker\services\menus\display($this->get('dbal.conn'), $this->get('user'), 'forum_sm_menu_items', 'item_id');
    }
    ...
    {
        return $this->services['blitze.sitemaker.menus.navigation'] = new \blitze\sitemaker\services\menus\navigation($this->get('cache.driver'), $this->get('blitze.sitemaker.mapper.factory'), new \blitze\sitemaker\services\menus\display($this->get('dbal.conn'), $this->get('user'), 'forum_sm_menu_items', 'item_id'), 'php');
    }
    ...
    {
        return $this->services['ext.manager'] = new \phpbb\extension\manager($this, $this->get('dbal.conn'), $this->get('config'), $this->get('filesystem'), 'forum_ext', './../', 'php', $this->get('cache'));
    }
    ...
    {
        return $this->services['migrator.tool.module'] = new \phpbb\db\migration\tool\module($this->get('dbal.conn'), $this->get('cache'), $this->get('user'), $this->get('module.manager'), './../', 'php', 'forum_modules');
    }
    ...
    {
        return $this->services['module.manager'] = new \phpbb\module\module_manager($this->get('cache.driver'), $this->get('dbal.conn'), $this->get('ext.manager'), 'forum_modules', './../', 'php');
    }
    ...
    {
        return new \phpbb\notification\method\board($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('config'), 'forum_notification_types', 'forum_notifications');
    }
    ...
    {
        $instance = new \phpbb\notification\type\admin_activate_user($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'forum_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\approve_post($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'forum_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\approve_topic($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'forum_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\bookmark($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'forum_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\disapprove_post($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'forum_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\disapprove_topic($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'forum_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\group_request($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'forum_user_notifications');
    ...
    {
        return new \phpbb\notification\type\group_request_approved($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'forum_user_notifications');
    }
    ...
    {
        $instance = new \phpbb\notification\type\pm($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'forum_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\post($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'forum_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\post_in_queue($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'forum_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\quote($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'forum_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\report_pm($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'forum_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\report_pm_closed($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'forum_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\report_post($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'forum_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\report_post_closed($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'forum_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\topic($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'forum_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\topic_in_queue($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './../', 'php', 'forum_user_notifications');
    ...
    {
        return $this->services['notification_manager'] = new \phpbb\notification\manager($this->get('notification.type_collection'), $this->get('notification.method_collection'), $this, $this->get('user_loader'), $this->get('dispatcher'), $this->get('dbal.conn'), $this->get('cache'), $this->get('language'), $this->get('user'), 'forum_notification_types', 'forum_user_notifications');
    }
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_0000000045193521000000004a5f9a4c(
    ...
    {
        return $this->services['text_formatter.data_access'] = new \phpbb\textformatter\data_access($this->get('dbal.conn'), 'forum_bbcodes', 'forum_smilies', 'forum_styles', 'forum_words', './../styles/');
    }
    ...
    {
        $this->services['text_reparser.forum_description'] = $instance = new \phpbb\textreparser\plugins\forum_description($this->get('dbal.conn'), 'forum_forums');
    ...
    {
        $this->services['text_reparser.forum_rules'] = $instance = new \phpbb\textreparser\plugins\forum_rules($this->get('dbal.conn'), 'forum_forums');
    ...
    {
        $this->services['text_reparser.group_description'] = $instance = new \phpbb\textreparser\plugins\group_description($this->get('dbal.conn'), 'forum_groups');
    ...
    {
        $this->services['text_reparser.pm_text'] = $instance = new \phpbb\textreparser\plugins\pm_text($this->get('dbal.conn'), 'forum_privmsgs');
    ...
    {
        $this->services['text_reparser.poll_title'] = $instance = new \phpbb\textreparser\plugins\poll_title($this->get('dbal.conn'), 'forum_topics');
    ...
    {
        $this->services['text_reparser.post_text'] = $instance = new \phpbb\textreparser\plugins\post_text($this->get('dbal.conn'), 'forum_posts');
    ...
    {
        $this->services['text_reparser.user_signature'] = $instance = new \phpbb\textreparser\plugins\user_signature($this->get('dbal.conn'), 'forum_users');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'tables.sitemaker.blocks' => 'forum_sm_blocks',
            'tables.sitemaker.block_routes' => 'forum_sm_block_routes',
            'tables.sitemaker.cblocks' => 'forum_sm_cblocks',
            'tables.sitemaker.menus' => 'forum_sm_menus',
            'tables.sitemaker.menu_items' => 'forum_sm_menu_items',
...
class phpbbtemplatetwiglexer_0000000045193521000000004a5f9a4c extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5bfef5c7e589c973493061 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5bfef5c7e58a8421759448 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5bfef5c7e586f714604863 = array(
    ...
    {
        $this->initializer5bfef5c7e58a8421759448 && ($this->initializer5bfef5c7e58a8421759448->__invoke($valueHolder5bfef5c7e589c973493061, $this, 'set_environment', array('env' => $env), $this->initializer5bfef5c7e58a8421759448) || 1) && $this->valueHolder5bfef5c7e589c973493061 = $valueHolder5bfef5c7e589c973493061;

        return $this->valueHolder5bfef5c7e589c973493061->set_environment($env);
    }
    ...
    {
        $this->initializer5bfef5c7e58a8421759448 && ($this->initializer5bfef5c7e58a8421759448->__invoke($valueHolder5bfef5c7e589c973493061, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5bfef5c7e58a8421759448) || 1) && $this->valueHolder5bfef5c7e589c973493061 = $valueHolder5bfef5c7e589c973493061;

        return $this->valueHolder5bfef5c7e589c973493061->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5bfef5c7e58a8421759448 && ($this->initializer5bfef5c7e58a8421759448->__invoke($valueHolder5bfef5c7e589c973493061, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5bfef5c7e58a8421759448) || 1) && $this->valueHolder5bfef5c7e589c973493061 = $valueHolder5bfef5c7e589c973493061;

        return $this->valueHolder5bfef5c7e589c973493061->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5bfef5c7e58a8421759448 = $initializer;
    }
    ...
    {
        $this->initializer5bfef5c7e58a8421759448 && ($this->initializer5bfef5c7e58a8421759448->__invoke($valueHolder5bfef5c7e589c973493061, $this, '__get', array('name' => $name), $this->initializer5bfef5c7e58a8421759448) || 1) && $this->valueHolder5bfef5c7e589c973493061 = $valueHolder5bfef5c7e589c973493061;

        if (isset(self::$publicProperties5bfef5c7e586f714604863[$name])) {
            return $this->valueHolder5bfef5c7e589c973493061->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5bfef5c7e589c973493061;
    ...
    {
        $this->initializer5bfef5c7e58a8421759448 && ($this->initializer5bfef5c7e58a8421759448->__invoke($valueHolder5bfef5c7e589c973493061, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5bfef5c7e58a8421759448) || 1) && $this->valueHolder5bfef5c7e589c973493061 = $valueHolder5bfef5c7e589c973493061;
    ...
    {
        $this->initializer5bfef5c7e58a8421759448 && ($this->initializer5bfef5c7e58a8421759448->__invoke($valueHolder5bfef5c7e589c973493061, $this, '__isset', array('name' => $name), $this->initializer5bfef5c7e58a8421759448) || 1) && $this->valueHolder5bfef5c7e589c973493061 = $valueHolder5bfef5c7e589c973493061;
    ...
    {
        $this->initializer5bfef5c7e58a8421759448 && ($this->initializer5bfef5c7e58a8421759448->__invoke($valueHolder5bfef5c7e589c973493061, $this, '__unset', array('name' => $name), $this->initializer5bfef5c7e58a8421759448) || 1) && $this->valueHolder5bfef5c7e589c973493061 = $valueHolder5bfef5c7e589c973493061;
    ...
    {
        $this->initializer5bfef5c7e58a8421759448 && ($this->initializer5bfef5c7e58a8421759448->__invoke($valueHolder5bfef5c7e589c973493061, $this, '__clone', array(), $this->initializer5bfef5c7e58a8421759448) || 1) && $this->valueHolder5bfef5c7e589c973493061 = $valueHolder5bfef5c7e589c973493061;

        $this->valueHolder5bfef5c7e589c973493061 = clone $this->valueHolder5bfef5c7e589c973493061;
    }

    public function __sleep()
    {
        $this->initializer5bfef5c7e58a8421759448 && ($this->initializer5bfef5c7e58a8421759448->__invoke($valueHolder5bfef5c7e589c973493061, $this, '__sleep', array(), $this->initializer5bfef5c7e58a8421759448) || 1) && $this->valueHolder5bfef5c7e589c973493061 = $valueHolder5bfef5c7e589c973493061;

        return array('valueHolder5bfef5c7e589c973493061');
    }
    ...
    {
        return $this->initializer5bfef5c7e58a8421759448;
    }
    ...
    {
        return $this->initializer5bfef5c7e58a8421759448 && ($this->initializer5bfef5c7e58a8421759448->__invoke($valueHolder5bfef5c7e589c973493061, $this, 'initializeProxy', array(), $this->initializer5bfef5c7e58a8421759448) || 1) && $this->valueHolder5bfef5c7e589c973493061 = $valueHolder5bfef5c7e589c973493061;
    }
    ...
    {
        return null !== $this->valueHolder5bfef5c7e589c973493061;
    }
    ...
    {
        return $this->valueHolder5bfef5c7e589c973493061;
    }
